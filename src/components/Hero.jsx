...
export const Hero = () => {
  return (
    <>
      <div id="hero-main" className="w-full  relative">
        <div className="w-full h-full">
          ...
          <div>
            <button
              id="hero-btn"
              className="text-white border-2 border-white rounded-lg absolute top-[5%] right-[5%] py-1 px-2 hidden"
            >
              Join Group
            </button>
          </div>
        ...
        <div
          id="hero-txt"
          className="text-white absolute bottom-[15%] left-[10%] max-sm:left-[4%]"
        >
